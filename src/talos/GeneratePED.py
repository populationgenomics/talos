...
PARTICIPANT_QUERY = gql(
    """
query MyQuery($project: String!, $sequencing_type: String!) {
...
def get_data_from_metamist(project: str, seq_type: str) -> list[list[str]]:
    """
    ...
    result = query(PARTICIPANT_QUERY, variables={'project': project, 'sequencing_type': seq_type})
...
def main():
    ...
    new_ped_rows = get_data_from_metamist(args.dataset, seq_type=args.type)
