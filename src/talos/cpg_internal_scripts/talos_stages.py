...
def get_clinvar_table(key: str = 'clinvarbitration') -> str:
    """
    TODO change this into a metamist query? Currently using fewgenomes and type "clinvarbitration"
...
class RunHailFiltering(DatasetStage):
    ...
    def queue_jobs(self, dataset: Dataset, inputs: StageInput) -> StageOutput:
        ...
        if (required_storage := config_retrieve(['workflow', 'es_storage'], None)) is None:
