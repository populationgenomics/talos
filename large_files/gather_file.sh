...
# Ensembl GFF3 data
start_download https://ftp.ensembl.org/pub/release-116/gff3/homo_sapiens/Homo_sapiens.GRCh38.116.gff3.gz

# Jax lab file for phenotype matching
start_download https://github.com/obophenotype/human-phenotype-ontology/releases/download/v2026-01-08/hp.obo

start_download https://github.com/obophenotype/human-phenotype-ontology/releases/download/v2026-01-08/genes_to_phenotype.txt
