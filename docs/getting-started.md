...
See [`large_files/README.md`](https://github.com/populationgenomics/talos/blob/main/large_files/README.md) in the repository for the full list of sources, and the helper script [`large_files/gather_file.sh`](https://github.com/populationgenomics/talos/blob/main/large_files/gather_file.sh), which performs the initial download.
