...
| `am_pathogenicity`        | A float, defining the minimum AlphaMissense pathogenicity score to be treated as pathogenic. Replaces deference to AlphaMissense's default am_class value, which is using the 0.564 score as a Likely Pathogenic threshold                                 | 0.546                                                                         |                                                                                                   |
