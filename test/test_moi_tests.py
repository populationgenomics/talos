...
def test_moi_runner(moi_string: str, filters: list[str], peddy_ped):
    ...
    """
    test_runner = MOIRunner(pedigree=make_flexible_pedigree(peddy_ped), target_moi=moi_string)
...
def test_dominant_autosomal_fails_on_depth(peddy_ped):
    ...
    dom = DominantAutosomal(pedigree=make_flexible_pedigree(peddy_ped))
...
def test_recessive_autosomal_hom_passes(peddy_ped):
    ...
    rec = RecessiveAutosomalHomo(pedigree=make_flexible_pedigree(peddy_ped))
...
def test_recessive_autosomal_comp_het_male_passes(peddy_ped):
    ...
    rec = RecessiveAutosomalCH(pedigree=make_flexible_pedigree(peddy_ped))
...
def test_x_dominant_female_and_male_het_passes(peddy_ped):
    ...
    x_dom = XDominant(pedigree=make_flexible_pedigree(peddy_ped))
...
def test_x_recessive_male_hom_passes(peddy_ped):
    ...
    x_rec = XRecessiveMale(pedigree=make_flexible_pedigree(peddy_ped))
...
def test_x_recessive_female_hom_passes(peddy_ped):
    ...
    x_rec = XRecessiveFemaleHom(pedigree=make_flexible_pedigree(peddy_ped))
    results = x_rec.run(passing_variant, comp_het={})
    assert len(results) == 1
...
def test_x_recessive_female_het_passes(peddy_ped):
    ...
    x_rec = XRecessiveFemaleCH(pedigree=make_flexible_pedigree(peddy_ped))
...
def test_het_de_novo_passes(peddy_ped):
    ...
    dom_a = DominantAutosomal(pedigree=make_flexible_pedigree(peddy_ped))
...
def test_x_recessive_female_het_no_pair_fails(second_hit: mock.Mock, peddy_ped):
    ...
    assert not XRecessiveFemaleCH(pedigree=make_flexible_pedigree(peddy_ped)).run(passing_variant)
...
def test_check_familial_inheritance_simple(peddy_ped):
    ...
    base_moi = BaseMoi(pedigree=make_flexible_pedigree(peddy_ped), applied_moi='applied')
...
def test_genotype_calls(peddy_ped):
    ...
    """
    base_moi = DominantAutosomal(pedigree=make_flexible_pedigree(peddy_ped), applied_moi='applied')
