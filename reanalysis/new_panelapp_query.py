...
def main(panels: str | None, out_path: str, previous: str | None):
    """
    start off with an initial gene dict
    Args:
        panels ():
        out_path ():
        previous ():
...
if __name__ == '__main__':
    ...
    parser.add_argument('--previous', default=None, help='JSON of previous results')
    parser.add_argument('--panels', default=None, help='JSON of per-participant panels')
    parser.add_argument('--out', required=True, help='Path to write results to')
    args = parser.parse_args()

    main(panels=args.panels, out_path=args.out, previous=args.previou)
